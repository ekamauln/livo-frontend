...
const returnCreateSchema = z.object({
  ...
  scrap_number: z.string().optional(),
});
...
export function ReturnCreateDialog({
  ...
  const onSubmit = async (data: ReturnCreateFormData) => {
    setIsLoading(true);
    try {
      const response = await returnApi.createReturn(data);
      ...
      <DialogContent className="min-w-[700px] max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            <Package className="h-5 w-5" /> Create New Return
          </DialogTitle>
          <DialogDescription>
            Create a new return by filling out the form below.
          </DialogDescription>
          <Separator
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Enter new tracking number (e.g., JNE1234567890)"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Enter old tracking number (e.g., JNE1234567890)"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field: returnTypeField }) => (
                  <FormItem>
                    <FormLabel className="text-xs">Return Type</FormLabel>
                    <FormControl>
                      <Popover
                      ...
                      >
                        <PopoverTrigger asChild>
                          ...
                          >
                            {getSelectedReturnTypeText(returnTypeField.value)}
                            <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                          </Button>
                        </PopoverTrigger>
                        <PopoverContent className="w-full p-0">
                                ...
                                {returnTypeOptions
                                  ...
                                  .map((option) => (
                                    <CommandItem
                                      ...
                                      value={option.value}
                                      onSelect={() => {
                                        returnTypeField.onChange(option.value);
                                        setReturnTypeSearchOpen(false);
                                      }}
                                    >
                                      <Check
                                        className={cn(
                                          "mr-2 h-4 w-4",
                                          returnTypeField.value === option.value
                                            ? "opacity-100"
                                            : "opacity-0"
                                        )}
                                      />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        placeholder="Enter return reason (e.g., Defective, Wrong Item, etc.)"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Enter return number (e.g., 1111)"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder="Enter scrap number (e.g., 1111)"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
