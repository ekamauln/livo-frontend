        ...
        if (boxReport.details && boxReport.details.length > 0) {
          boxReport.details.forEach((detail) => {
            allBoxDetails.push({
              ...
              order_ginee_id: detail.order_ginee_id,
                                ...
                                <TableBody>
                                  {details.map((detail, idx) => (
                                    <TableRow key={idx}>
                                      ...
                                      <TableCell className="text-center text-sm">
                                        {detail.source === "QC Ribbon" ? (
                                          <span className="inline-flex items-center rounded-full px-2 py-1 text-xs font-medium bg-green-600 text-white">
                                            {detail.source}
                                          </span>
                                        ) : (
                                          <span className="inline-flex items-center rounded-full px-2 py-1 text-xs font-medium bg-orange-600 text-white">
                                            {detail.source}
                                          </span>
                                        )}
                                      </TableCell>
